...
static const LcdExpr sleepy_annoyed_expressions[] = {
    // groggy / confused
    { "huh...??",        "zzzz..."       },
    { "wha...??",        "im sleeping!"  },
    { "...mmph",         "go away..."    },
    ...
    // passive aggressive
    { "oh WOW",          "really?? :("   },
    { "so kind of u",    "to wake me :(" },
    { "thanks.",         "really. :("    },
    { "how lovely",      "zzz... :("     },
    { "oh sure yeah",    "wake me up :(" },
    { "no no please",    "continue... :(",},
    { "dont mind me",    "just sleeping" },
    { "by all means",    "be loud :("    },
    { "oh its fine",     "...its not :(" },
    { "totally fine",    "zzz >:("       },
    ...
    { "ruined!!",        "all ruined :(" },
    { "i needed",        "that sleep :(" },
    { "do u know",       "what u did :(" },
    { "my poor",         "tired eyes :(" },
    { "exhausted...",    "so tired :("   },
    { "cant function",   "need sleep :(" },
    { "running on",      "no sleep :("   },
    { "send help",       "and silence :(",},
    { "too tired",       "for this :("   },

    // bargaining
    { "5 more mins",     "please... :("  },
    { "just 2 mins",     "thats all :("  },
    { "one more hour",   "i beg u :("    },
    { "please...",       "let me sleep"  },
    { "ill be nicer",    "after sleep :)",},
    { "promise im fun",  "after nap :)"  },
    { "just a lil nap",  "thats all :("  },
    { "almost done",     "sleeping :("   },
    { "so close to",     "deep sleep :(" },
    { "was so close",    "to dreaming :(",},
};
